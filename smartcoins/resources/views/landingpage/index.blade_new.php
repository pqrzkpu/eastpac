            ...
            <div class="collapse navbar-collapse justify-content-between" id="navbarToggle">
                ...
                <ul class="navbar-btns animated remove-animation" data-animate="fadeInDown" data-delay=".85">
                    <li class="nav-item lang-switch">
                        <a class="" href="#" data-toggle="dropdown">English</em></a>
                    </li>
                    @if(Auth::guest())
				...
				<div class="col-md-10">
                    ...
                    <div class="row">
                        <div class="col-md-12 text-center">
                            <a href="#" style="color:white;" id="edit-about-1" onclick="return false;" class="btn btn-success btn-edit"><i class="fa fa-pencil"> Edit</i></a>
                            <a href="#" id="cancel-about-1" onclick="return false;" class="btn btn-success btn-edit pull-right" style="display:none;color:white;"><i class="fa fa-times"> Cancel</i></a>
                            <a href="#" style="display:none;color:white;" id="save-about-1" onclick="return false;" class="btn btn-success btn-edit pull-right"><i class="fa fa-save"> Save</i></a>
        ...
        <div class="container">
            <div class="row align-items-center">
                ...
                <div class="col-lg-5 text-center text-lg-left res-m-bttm">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <a href="#" style="color:white;" id="edit-about-2" onclick="return false;" class="btn btn-success btn-edit" style="color:white;"><i class="fa fa-pencil"> Edit</i></a>
                            <a href="#" id="cancel-about-2" onclick="return false;" class="btn btn-success btn-edit pull-right" style="display:none;color:white;"><i class="fa fa-times" style=""> Cancel</i> </a>
                            <a href="#" id="save-about-2" onclick="return false;" class="btn btn-success btn-edit pull-right" style="display:none;color:white;"><i class="fa fa-save"> Save </i> </a>
        ...
        <div class="container">
            <div class="row justify-content-center text-center">
				<div class="col-md-6 col-sm-8">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <a href="#" id="edit-beneffit" onclick="return false;" class="btn btn-success btn-edit" style="color:white;" ><i class="fa fa-pencil"> Edit</i></a>
                            <a href="#" id="save-beneffit" onclick="return false;" class="btn btn-success btn-edit pull-right" style="display:none;color:white;"><i class="fa fa-save"> Save </i> </a>
                            <a href="#" id="cancel-beneffit" onclick="return false;" class="btn btn-success btn-edit pull-right" style="display:none;color:white;"><i class="fa fa-times" style=""> Cancel</i> </a>
                        </div>
                    </div>
                    @endrole
				</div>
            ...
            <div class="tokdis-list">
                <div class="row text-center text-lg-left">
                    <div class="col-md">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <a href="#" style="color:white;" id="edit-token-1" onclick="return false;" class="btn btn-success btn-edit" ><i class="fa fa-pencil"> Edit</i></a>
                                <a href="#"  id="save-token-1" onclick="return false;" class="btn btn-success btn-edit pull-right" style="display:none;color:white;"><i class="fa fa-save"> Save </i> </a>
                                <a href="#"  id="cancel-token-1" onclick="return false;" class="btn btn-success btn-edit pull-right" style="display:none;color:white;"><i class="fa fa-times" style=""> Cancel</i> </a>
                            </div>
                        </div>
                        @endrole
                    </div><!-- .col -->
                    <div class="col-md">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <a href="#" style="color:white;" class="btn btn-success btn-edit"  id="edit-token-2" onclick="return false;"><i class="fa fa-pencil"> Edit</i></a>
                                <a href="#" class="btn btn-success btn-edit pull-right" style="display:none;color:white;" id="save-token-2" onclick="return false;"><i class="fa fa-save"> Save </i> </a>
                                <a href="#"  id="cancel-token-2" onclick="return false;" class="btn btn-success btn-edit pull-right" style="display:none;color:white;" ><i class="fa fa-times" style=""> Cancel</i> </a>
                            </div>
                        </div>
                        @endrole
                    </div><!-- .col -->
                    <div class="col-md">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <a href="#" style="color:white;" class="btn btn-success btn-edit" id="edit-token-3" onclick="return false;"><i class="fa fa-pencil"> Edit</i></a>
                                <a href="#" class="btn btn-success btn-edit pull-right" style="display:none;color:white;" id="save-token-3" onclick="return false;"><i class="fa fa-save"> Save </i> </a>
                                <a href="#" class="btn btn-success btn-edit pull-right" style="display:none;color:white;" id="cancel-token-3" onclick="return false;"><i class="fa fa-times" style=""> Cancel</i> </a>
                            </div>
                        </div>
                        @endrole
                    </div><!-- .col -->
                    <div class="col-lg-4">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <a href="#" style="color:white;" class="btn btn-success btn-edit" id="edit-token-4" onclick="return false;"><i class="fa fa-pencil"> Edit</i></a>
                                <a href="#" class="btn btn-success btn-edit pull-right" style="display:none;color:white;" id="save-token-4" onclick="return false;"><i class="fa fa-save"> Save </i> </a>
                                <a href="#" class="btn btn-success btn-edit pull-right" style="display:none;color:white;" id="cancel-token-4" onclick="return false;"><i class="fa fa-times" style=""> Cancel</i> </a>
                            </div>
                        </div>
                        @endrole
                    </div><!-- .col -->
...
-->
	    ...
	    <div class="container">
            <div class="row justify-content-center text-center">
				<div class="col-lg-6 col-sm-8">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <a href="#" style="color:white;" class="btn btn-success btn-edit" id="edit-token-11" onclick="return false;"><i class="fa fa-pencil"> Edit</i></a>
                            <a href="#" class="btn btn-success btn-edit pull-right" style="display:none;color:white;" id="save-token-11" onclick="return false;"><i class="fa fa-save"> Save </i> </a>
                            <a href="#" class="btn btn-success btn-edit pull-right" style="display:none;color:white;" id="cancel-token-11" onclick="return false;"><i class="fa fa-times" style=""> Cancel</i> </a>
                        </div>
                    </div>
                    @endrole
                </div>
	            ...
	            <div class="col-lg-7 res-m-bttm">
	                <div class="row justify-content-between text-center text-lg-left">
	                    <div class="col-xl-5 col-md-6">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <a href="#" style="color:white;" class="btn btn-success btn-edit" id="edit-token-21" onclick="return false;"><i class="fa fa-pencil"> Edit</i></a>
                                    <a href="#" class="btn btn-success btn-edit pull-right" style="display:none;color:white;" id="save-token-21" onclick="return false;"><i class="fa fa-save"> Save </i> </a>
                                    <a href="#" class="btn btn-success btn-edit pull-right" style="display:none;color:white;" id="cancel-token-21" onclick="return false;"><i class="fa fa-times" style=""> Cancel</i> </a>
                                </div>
                            </div>
                            @endrole
	                    </div><!-- .col -->
	                    <div class="col-xl-5 col-md-6">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <a href="#" style="color:white;" class="btn btn-success btn-edit" id="edit-token-22" onclick="return false;"><i class="fa fa-pencil"> Edit</i></a>
                                    <a href="#" class="btn btn-success btn-edit pull-right" style="display:none;color:white;" id="save-token-22" onclick="return false;"><i class="fa fa-save"> Save </i> </a>
                                    <a href="#" class="btn btn-success btn-edit pull-right" style="display:none;color:white;" id="cancel-token-22" onclick="return false;"><i class="fa fa-times" style=""> Cancel</i> </a>
                                </div>
                            </div>
                            @endrole
	                    </div><!-- .col -->
	                    <div class="col-xl-5 col-md-6">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <a href="#" style="color:white;" class="btn btn-success btn-edit" id="edit-token-23" onclick="return false;"><i class="fa fa-pencil"> Edit</i></a>
                                    <a href="#" class="btn btn-success btn-edit pull-right" style="display:none;color:white;" id="save-token-23" onclick="return false;"><i class="fa fa-save"> Save </i> </a>
                                    <a href="#"class="btn btn-success btn-edit pull-right" style="display:none;color:white;" id="cancel-token-23" onclick="return false;"><i class="fa fa-times" style=""> Cancel</i> </a>
                                </div>
                            </div>
                            @endrole
	                    </div><!-- .col -->
	                    <div class="col-xl-5 col-md-6">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <a href="#" style="color:white;" class="btn btn-success btn-edit" id="edit-token-24" onclick="return false;"><i class="fa fa-pencil"> Edit</i></a>
                                    <a href="#" class="btn btn-success btn-edit pull-right" style="display:none;color:white;" id="save-token-24" onclick="return false;"><i class="fa fa-save"> Save </i> </a>
                                    <a href="#" class="btn btn-success btn-edit pull-right" style="display:none;color:white;" id="cancel-token-24" onclick="return false;"><i class="fa fa-times" style=""> Cancel</i> </a>
                                </div>
                            </div>
                            @endrole
	                    </div><!-- .col -->
                    ...
                    <div class="col-xl-6 col-lg-8">
                        ...
                        <div class="row" style="">
                            <div class="col-md-12" style="margin-bottom:40px;">
                                <a href="#" style="color:white;" class="btn btn-success btn-edit" id="edit-team" onclick="return false;"><i class="fa fa-pencil"> Edit</i></a>
                                <a href="#" class="btn btn-success btn-edit pull-right" style="display:none;color:white;" id="save-team" onclick="return false;"><i class="fa fa-save"> Save </i> </a>
                                <a href="#" class="btn btn-success btn-edit pull-right" style="display:none;color:white;" id="cancel-team" onclick="return false;"><i class="fa fa-times" style=""> Cancel</i> </a>
                            </div>
                        </div>
                        @endrole
                    </div>
		...
		<div class="container">
			<div class="row justify-content-center text-center">
				<div class="col-md-7">
                    ...
                    <div class="row" style="">
                        <div class="col-md-12" style="margin-bottom:40px;">
                            <a href="#" id="edit-faq" onclick="return false;" class="btn btn-success btn-edit pull-right" style="display:none;color:white;"><i class="fa fa-pencil"> Edit</i></a>
                            <a href="#" id="save-faq" onclick="return false;" class="btn btn-success btn-edit pull-right" style="display:none;color:white;"><i class="fa fa-save"> Save </i> </a>
                            <a href="#" id="cancel-faq" onclick="return false;" class="btn btn-success btn-edit pull-right" style="display:none;color:white;"><i class="fa fa-times" style=""> Cancel</i> </a>
                        </div>
                    </div>
                    @endrole
				</div>
    ...
    <script>
        ...
        $('#txt-banner-1').click(function() {
            ...
            $(this).css('border', '1px solid #fe4350');
        ...
        $('#edit-token-1').click(function() {
            ...
            $('#txt-token-1').css('border','1px solid #fe4350');
            $('#txt-token-1').focus();
            $('#save-token-1').show();
            $('#cancel-token-1').show();
        ...
        $('#edit-token-2').click(function() {
            ...
            $('#txt-token-2').css('border','1px solid #fe4350');
            $('#txt-token-2').focus();
            $('#save-token-2').show();
            $('#cancel-token-2').show();
        });
        ...
        $('#edit-token-3').click(function() {
            ...
            $('#txt-token-3').css('border','1px solid #fe4350');
            $('#txt-token-3').focus();
            $('#save-token-3').show();
            $('#cancel-token-3').show();
        ...
        $('#edit-token-4').click(function() {
            ...
            $('#txt-token-4').css('border','1px solid #fe4350');
            $('#txt-token-4').focus();
            $('#save-token-4').show();
            $('#cancel-token-4').show();
        ...
        $('#edit-token-11').click(function() {
            ...
            $('#txt-token-11').css('border','1px solid #fe4350');
            $('#txt-token-11').focus();
            $('#save-token-11').show();
        ...
        $('#edit-token-21').click(function() {
            ...
            $('#txt-token-21').css('border','1px solid #fe4350');
            $('#txt-token-21').focus();
            $('#save-token-21').show();
        ...
        $('#edit-token-22').click(function() {
            ...
            $('#txt-token-22').css('border','1px solid #fe4350');
            $('#txt-token-22').focus();
            $('#save-token-22').show();
        ...
        $('#edit-token-23').click(function() {
            ...
            $('#txt-token-23').css('border','1px solid #fe4350');
            $('#txt-token-23').focus();
            $('#save-token-23').show();
        ...
        $('#edit-token-24').click(function() {
            ...
            $('#txt-token-24').css('border','1px solid #fe4350');
            $('#txt-token-24').focus();
            $('#save-token-24').show();
        ...
        $('#edit-team').click(function() {
            ...
            $('#txt-team').css('border','1px solid #fe4350');
            $('#txt-team').focus();
            $('#save-team').show();
            $('#cancel-team').show();
        });
        ...
        $('#edit-faq').click(function() {
            ...
            $('#txt-faq').css('border','1px solid #fe4350');
            $('#txt-faq').focus();
            $('#save-faq').show();
            $('#cancel-faq').show();
        });
